...
namespace ConstructSurface
{
    ...
    {
        public class ShellCubesDispatch_Experiment : MonoBehaviour
        {
            ...
            int kernelIdentifierXY;
            int kernelIdentifierZY;
            int kernelIdentifierXZ;
            int kernelLabeler;
            int kernelFindRootLabel;
            int kernelLookUp;
            int kernelArg;
            const int GROUPSIZE2D = 4;
            const int GROUPSIZE3D = 8;
            const int MAXITERATIONS = 80; // max iteration for the CCL
            ...
            private void Start()
            {
                ...
                triangleBuffer = new ComputeBuffer(((resolution_x * resolution_y) + (resolution_y * resolution_z) + (resolution_x * resolution_z)) * dexelSegments * 2,
                ...
                kernelIdentifierXY = cubeIdentifier.FindKernel("UpdateCubeStates_XY");
                kernelIdentifierZY = cubeIdentifier.FindKernel("UpdateCubeStates_ZY");
                kernelIdentifierXZ = cubeIdentifier.FindKernel("UpdateCubeStates_XZ");
                ...
                cubeIdentifier.SetBuffer(kernelIdentifierXY, "cubeBuffer", cubeBuffer);
                cubeIdentifier.SetBuffer(kernelIdentifierZY, "cubeBuffer", cubeBuffer);
                cubeIdentifier.SetBuffer(kernelIdentifierXZ, "cubeBuffer", cubeBuffer);
            ...
            void Dispatch()
            {
                // initialize cube buffer and label buffer
                cubeIdentifier.SetTexture(kernelInitialize, "labelBuffer1", LabelTexture1);
                cubeIdentifier.SetTexture(kernelInitialize, "labelBuffer2", LabelTexture2);
                ...
                // set tri-dexel data to identifier shader
                cubeIdentifier.SetTexture(kernelIdentifierXY, "xy_array", XYTexture);
                cubeIdentifier.SetTexture(kernelIdentifierXY, "zy_array", ZYTexture);
                cubeIdentifier.SetTexture(kernelIdentifierXY, "xz_array", XZTexture);
                cubeIdentifier.SetTexture(kernelIdentifierZY, "xy_array", XYTexture);
                cubeIdentifier.SetTexture(kernelIdentifierZY, "zy_array", ZYTexture);
                cubeIdentifier.SetTexture(kernelIdentifierZY, "xz_array", XZTexture);
                cubeIdentifier.SetTexture(kernelIdentifierXZ, "xy_array", XYTexture);
                cubeIdentifier.SetTexture(kernelIdentifierXZ, "zy_array", ZYTexture);
                cubeIdentifier.SetTexture(kernelIdentifierXZ, "xz_array", XZTexture);

                // set label buffers to identifier shader
                cubeIdentifier.SetTexture(kernelIdentifierXY, "labelBuffer1", LabelTexture1);
                cubeIdentifier.SetTexture(kernelIdentifierXY, "labelBuffer2", LabelTexture2);
                cubeIdentifier.SetTexture(kernelIdentifierZY, "labelBuffer1", LabelTexture1);
                cubeIdentifier.SetTexture(kernelIdentifierZY, "labelBuffer2", LabelTexture2);
                cubeIdentifier.SetTexture(kernelIdentifierXZ, "labelBuffer1", LabelTexture1);
                cubeIdentifier.SetTexture(kernelIdentifierXZ, "labelBuffer2", LabelTexture2);
                ...
                cubeIdentifier.Dispatch(kernelIdentifierXY, Mathf.CeilToInt(resolution_x / GROUPSIZE2D), Mathf.CeilToInt(resolution_y / GROUPSIZE2D), 1);
                cubeIdentifier.Dispatch(kernelIdentifierZY, 1, Mathf.CeilToInt(resolution_y / GROUPSIZE2D), Mathf.CeilToInt(resolution_z / GROUPSIZE2D));
                cubeIdentifier.Dispatch(kernelIdentifierXZ, Mathf.CeilToInt(resolution_x / GROUPSIZE2D), 1, Mathf.CeilToInt(resolution_z / GROUPSIZE2D));

                // set tri-dexel data to mesh generating shader
                ...
                if (readBack)
                {
                    ...
                    Triangle[] triangles = new Triangle[args[0] / 3];
                    triangleBuffer.GetData(triangles);
                    meshReadBackThread = new Thread(() => AsyncReadBackMesh(triangles));
            ...
            void AsyncReadBackMesh(Triangle[] triangles)
            {
                DateTime start = DateTime.Now;
                ...
                DateTime end = DateTime.Now;
                //Debug.Log("Read back time: " + (end - start).TotalSeconds);
            }
